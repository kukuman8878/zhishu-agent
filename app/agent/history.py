...
# 把会话消息渲染成多轮对话文本，截取最近 limit 条并截断单条长度；参数 messages=消息列表，limit=最多保留条数
def render_history(messages: list[AnyMessage], limit: int = 6) -> str:
    """渲染最近 limit 条对话为纯文本，供提示词注入历史上下文"""
